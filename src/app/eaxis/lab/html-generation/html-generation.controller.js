(function () {
    ...
    EAxisHtmlGenerationCodeController.$inject = ["$rootScope", "$scope", "$state", "$timeout", "$location", "$window", "APP_CONSTANT", "authService", "apiService", "helperService", "htmlCodeGenerationConfig"];

    function EAxisHtmlGenerationCodeController($rootScope, $scope, $state, $timeout, $location, $window, APP_CONSTANT, authService, apiService, helperService, htmlCodeGenerationConfig) {
