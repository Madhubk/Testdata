(function () {
    ...
    function accountReceivableConfig($q, helperService, toastr) {
        ...
        function GetTabDetails(currentAccountReceivable, isNew) {
                    ...
                    "Header": {
                        ...
                        "API": {
                            "InsertAccountReceivable": {
                                "IsAPI": "true",
                                "HttpType": "POST",
                                "Url": "AccountReceivableList/Insert"
                            }
                        },
                        "Meta": {
            ...
            if (isNew) {
                _exports.Entities.Header.Data = currentAccountReceivable.data;
                var _code = currentAccountReceivable.entity.PK.split("-").join("");
                ...
                var _obj = {
                    ...
                    label: 'New',
                    code: _code,
                    pk: currentAccountReceivable.entity.PK,
                    isNew: isNew
                };
                ...
                helperService.getFullObjectUsingGetById(exports.Entities.API.AccountreceivableList.API.GetById.Url, currentAccountReceivable.PK).then(function (response) {
                    ...
                    var _code = currentAccountReceivable.PK.split("-").join("");
                    var obj = {
                        [_code]: {
                            ePage: _exports
                        },
                        label: currentAccountReceivable.Desc,
                        code: _code,
                        pk: currentAccountReceivable.PK,
                        isNew: isNew
                    };
