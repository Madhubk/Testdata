        ...
        $stateProvider
            ...
            .state('EA.freight.consolidation', {
                ...
                resolve: {
                    ...
                    LoadState: ["$ocLazyLoad", "CheckAccess", function ($ocLazyLoad, CheckAccess) {
                        return $ocLazyLoad.load(["chromeTab", "dynamicTable", "confirmation", "compareDate", "dynamicListModal", "dynamicList", "dynamicLookup", "dynamicControl", "dynamicGrid", "drogAndDrop", "oneLevelMapping", "Summernote", "CustomFileUpload", "standardMenu", "Comment", "CommentModal", "Document", "DocumentModal", "Email", "EmailModal", "Exception", "ExceptionModal", "Event", "EventModal", "AuditLog", "AuditLogModal", "DataEvent", "DataEventModal", "EmailGroup", "EmailGroupModal", "EmailTemplateCreation", "EmailTemplateCreationModal", "Task", "TaskModal", "Keyword", "KeywordModal", "Parties", "PartiesModal", "addressDirective", "addressModal", "addressWrapper", "ActivityTab", "MyTaskConfig", "MyTaskDynamicDirective", "UploadDocument", "AddComment", "ViewDocument", "ViewComment", "consolidation", "consolGeneral", "ConsolArrivalDeparture", "consolContainer", "ContainerDirectives", "consolMenu", "routing", "consolContainerPopup", "ConsolShipment", "ConsolPacking", "consolMyTask", "ConsolCommonFieldsDirective", "ConsolCommonDocsDirective", "ConsolDetailsDirective", "ContainerEditableGridDirective", "EditableTableDirective", "RoutingGridDirective", "PackingGridDirective", "relatedShipment", "ConsolActivityDetailsDirective", "ConsolOrganizationDetailsDirective", "LinkedShipment", "ContainerDetails", "consolNewshipment", "MyTaskDirective", "OverrideKPI", "DelayReasonModal", "DelayReason", "ExportSeaConsolidationSIFilingGlb", "Checklist", "ChecklistModal", "ConsolCreationEvent", "TaskAssignStartComplete"]);
                    }]
                }
            })
