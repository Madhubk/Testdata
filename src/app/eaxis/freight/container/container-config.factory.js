(function () {
    ...
    angular
        .module("Application")
        .factory('ContainerConfig', ContainerConfig);

        ContainerConfig.$inject = ["$rootScope", "$location", "$q", "apiService", "helperService", "toastr"];

    function ContainerConfig($rootScope, $location, $q, apiService, helperService, toastr) {
        var exports = {
            "Entities": {
                "Header": {
                    "Data": {},
