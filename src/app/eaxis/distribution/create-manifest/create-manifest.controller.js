(function () {
    ...
    CreateManifestController.$inject = ["$location", "$scope", "APP_CONSTANT", "authService", "apiService", "helperService", "createmanifestConfig", "$timeout", "toastr", "appConfig", "$state", "$uibModal", "$window", "dynamicLookupConfig"];

    function CreateManifestController($location, $scope, APP_CONSTANT, authService, apiService, helperService, createmanifestConfig, $timeout, toastr, appConfig, $state, $uibModal, $window, dynamicLookupConfig) {
        ...
        function Init() {
            ...
            CreateManifestCtrl.ePage.Masters.dynamicLookupConfig = dynamicLookupConfig.Entities;
        ...
        function openModel() {
            return CreateManifestCtrl.ePage.Masters.modalInstance = $uibModal.open({
                ...
                scope: $scope,
                size: "md",
                templateUrl: "app/eaxis/distribution/create-manifest/create-manifest-popup.html"
            });
        }
