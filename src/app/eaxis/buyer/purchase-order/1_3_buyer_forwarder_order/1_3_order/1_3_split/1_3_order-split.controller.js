(function () {
    ...
    one_three_OrdSplitController.$inject = ["$window", "$injector", "$state", "apiService", "helperService", "appConfig"];

    function one_three_OrdSplitController($window, $injector, $state, apiService, helperService, appConfig) {
