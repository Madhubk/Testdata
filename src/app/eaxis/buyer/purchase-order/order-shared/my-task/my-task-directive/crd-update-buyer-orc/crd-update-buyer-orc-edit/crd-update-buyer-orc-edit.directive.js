(function () {
    ...
    function CrdUpdateBranchEditDirective() {
        var exports = {
            restrict: "EA",
            templateUrl: "app/eaxis/buyer/purchase-order/order-shared/my-task/my-task-directive/crd-update-buyer-orc/crd-update-buyer-orc-edit/crd-update-branch-edit.html",
    ...
    function CrdUpdateSupplierEditDirective() {
        var exports = {
            restrict: "EA",
            templateUrl: "app/eaxis/buyer/purchase-order/order-shared/my-task/my-task-directive/crd-update-buyer-orc/crd-update-buyer-orc-edit/crd-update-supplier-edit.html",
