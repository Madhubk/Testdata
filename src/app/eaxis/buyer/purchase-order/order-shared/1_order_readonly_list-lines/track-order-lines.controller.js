(function () {
    ...
    TrackOrderLineController.$inject = ["$timeout", "$location", "authService", "apiService", "helperService", "toastr", "buyerOrderLinesConfig"];

    function TrackOrderLineController($timeout, $location, authService, apiService, helperService, toastr, buyerOrderLinesConfig) {
        ...
        function Init() {
            TrackOrderLineCtrl.ePage = {
                ...
                "Entities": buyerOrderLinesConfig.Entities
            };
        ...
        function InitTrackOrderLine() {
            TrackOrderLineCtrl.ePage.Masters.taskName = "BPTrackOrderLine";
            TrackOrderLineCtrl.ePage.Masters.dataentryName = "BPTrackOrderLine";
        ...
        function AddTab(CurrentOrdLine, IsNew) {
            ...
            if (!_isExist) {
                ...
                buyerOrderLinesConfig.GetTabDetails(_CurrentOrdLine, IsNew).then(function (response) {
                    ...
                    $timeout(function () {
                        ...
                        TrackOrderLineCtrl.ePage.Masters.CurrentActiveTab(CurrentOrdLine.entity.POH_OrderNo);
                        TrackOrderLineCtrl.ePage.Masters.IsTabClick = false;
                    });
                });
            } else {
        ...
        function SelectedGridRow($item) {
            if ($item.action === "link" || $item.action === "dblClick") {
                ...
                $item.data.entity.PK=$item.data.entity.POH_FK;
                console.log($item.data.entity);
