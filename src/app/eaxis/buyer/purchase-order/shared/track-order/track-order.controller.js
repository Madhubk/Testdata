(function () {
    ...
    TrackOrderListController.$inject = ["$timeout", "authService", "apiService", "helperService", "one_order_listConfig", "toastr", "appConfig", "errorWarningService"];

    function TrackOrderListController($timeout, authService, apiService, helperService, one_order_listConfig, toastr, appConfig, errorWarningService) {
        ...
        function InitOrder() {
            // For list directive
            TrackOrderListCtrl.ePage.Masters.dataentryName = "TrackOrder";
