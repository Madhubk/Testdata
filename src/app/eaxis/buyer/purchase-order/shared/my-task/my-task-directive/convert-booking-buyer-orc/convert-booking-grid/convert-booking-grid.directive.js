(function () {
    ...
    function ConvertBookingSupplierGridDirective() {
        var exports = {
            restrict: "E",
            templateUrl: "app/eaxis/buyer/purchase-order/shared/my-task/my-task-directive/convert-booking-buyer-orc/convert-booking-grid/convert-booking-supplier-grid.html",
            link: Link,
    ...
    function ConvertBookingBranchGridDirective() {
        var exports = {
            restrict: "E",
            templateUrl: "app/eaxis/buyer/purchase-order/shared/my-task/my-task-directive/convert-booking-buyer-orc/convert-booking-grid/convert-booking-branch-grid.html",
            link: Link,
