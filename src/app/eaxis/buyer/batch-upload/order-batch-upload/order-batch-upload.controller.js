(function () {
    ...
    function one_one_POBatchUploadController($timeout, $scope, $location, $uibModal, apiService, helperService, one_poBatchUploadConfig, toastr, appConfig, confirmation) {
        ...
        function Init() {
            ...
            one_one_POBatchUploadCtrl.ePage.Masters.taskName = "BPBatchUpload_Buyer";
            one_one_POBatchUploadCtrl.ePage.Masters.dataentryName = "BPBatchUpload_Buyer";
            one_one_POBatchUploadCtrl.ePage.Masters.defaultFilter = {
               // "Source": "POB",
                "BatchUploadType": "UPO,UDO"
            };
                ...
                resolve: {
                    param: function () {
                        var exports = {
                            ...
                            "Config": one_one_POBatchUploadCtrl.ePage.Masters.StandardConfigInput
                        };
                        return exports;
                    }
                }
