(function () {
    ...
    RoutingGridController.$inject = ["$rootScope", "$scope", "$filter", "$timeout", "$injector", "APP_CONSTANT", "authService", "apiService", "helperService", "appConfig", "toastr", "confirmation", "$uibModal", "errorWarningService", "myTaskActivityConfig"];

    function RoutingGridController($rootScope, $scope, $filter, $timeout, $injector, APP_CONSTANT, authService, apiService, helperService, appConfig, toastr, confirmation, $uibModal, errorWarningService, myTaskActivityConfig) {
        ...
        function Init() {
            ...
            RoutingGridCtrl.ePage.Masters.TaskObj = myTaskActivityConfig.Entities.TaskObj;
            ...
            RoutingGridCtrl.ePage.Masters.OnFieldValueChange = OnFieldValueChange;

            RoutingGridCtrl.ePage.Masters.ErrorWarningConfig = errorWarningService;
        ...
        function More(index) {
            var modalInstance = $uibModal.open({
                ...
                scope: $scope,
                // size : "sm",
                templateUrl: "app/eaxis/buyer/freight/consolidation/1_4_buyer_imp_frwd_consollidation/my-task/shared/routing-grid/routing-grid-edit.html",
        ...
        function OnFieldValueChange(code) {
            var _obj = {
                ModuleName: [RoutingGridCtrl.ePage.Masters.TaskObj.WSI_StepCode],
                Code: [RoutingGridCtrl.ePage.Masters.TaskObj.WSI_StepCode],
                API: "Group",
                FilterInput: {
                    ModuleCode: "CON",
                    SubModuleCode: "CON"
                ...
                //     "Value": "TEST"
                // }],
                EntityObject: RoutingGridCtrl.ePage.Entities.Header.Data,
                ErrorCode: ['EV11026']
            };
            errorWarningService.ValidateValue(_obj);
            RoutingGridCtrl.ePage.Masters.ErrorWarningConfig.GlobalErrorWarningList = errorWarningService.Modules[RoutingGridCtrl.ePage.Masters.TaskObj.WSI_StepCode].Entity[RoutingGridCtrl.ePage.Masters.TaskObj.WSI_StepCode].GlobalErrorWarningList;
            RoutingGridCtrl.ePage.Masters.ErrorWarningConfig.ErrorWarningObj = errorWarningService.Modules[RoutingGridCtrl.ePage.Masters.TaskObj.WSI_StepCode].Entity[RoutingGridCtrl.ePage.Masters.TaskObj.WSI_StepCode];

        }
        function ValidationFindall() {
            if (RoutingGridCtrl.ePage.Masters.TaskObj) {
                ...
                var _obj = {
                    ...
                    GroupCode: RoutingGridCtrl.ePage.Masters.TaskObj.WSI_StepCode,
                    // RelatedBasicDetails: [{
                    //     "UIField": "TEST",
                    //     "DbField": "TEST",
                    //     "Value": "TEST"
