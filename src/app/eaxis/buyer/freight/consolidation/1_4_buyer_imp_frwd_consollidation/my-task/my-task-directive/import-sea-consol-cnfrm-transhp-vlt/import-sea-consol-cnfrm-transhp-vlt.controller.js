...
(function () {
    ...
    ImportSeaConsolConfirmTranshipmentVltController.$inject = ["$scope", "apiService", "helperService", "appConfig", "myTaskActivityConfig", "APP_CONSTANT", "authService", "errorWarningService", "three_consolidationConfig"];

    function ImportSeaConsolConfirmTranshipmentVltController($scope, apiService, helperService, appConfig, myTaskActivityConfig, APP_CONSTANT, authService, errorWarningService, three_consolidationConfig) {
        ...
        function GetEntityObj() {
            if (ImportSeaConsolConfirmTranshipmentVltCtrl.ePage.Masters.TaskObj.EntityRefKey) {
                apiService.get("eAxisAPI", three_consolidationConfig.Entities.Header.API.GetByID.Url + ImportSeaConsolConfirmTranshipmentVltCtrl.ePage.Masters.TaskObj.EntityRefKey).then(function (response) {
