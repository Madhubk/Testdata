(function () {
    ...
    angular
        .module("Application")
        .factory('three_consolidationConfig', ThreeConsolidationConfig);

    ThreeConsolidationConfig.$inject = ["$q", "apiService", "toastr", "helperService", "errorWarningService"];

    function ThreeConsolidationConfig($q, apiService, toastr, helperService, errorWarningService) {
        var exports = {
            "Entities": {
                "Header": {
                    "Data": {},
                    ...
                    "API": {
                        ...
                        "ConsolActivityClose": {
                            "IsAPI": "true",
                            "HttpType": "GET",
                            "Url": "consollist/buyer/consolactivityclose/",
                            "FilterID": ""
                        }
                    },
                    "Meta": {}
