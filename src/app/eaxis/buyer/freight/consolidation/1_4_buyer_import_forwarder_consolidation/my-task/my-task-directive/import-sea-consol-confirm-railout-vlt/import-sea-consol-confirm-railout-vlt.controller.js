...
(function () {
    ...
    ImportSeaConsolConfirmRailoutVltController.$inject = ["$scope", "apiService", "helperService", "appConfig", "myTaskActivityConfig", "APP_CONSTANT", "authService", "errorWarningService"];

    function ImportSeaConsolConfirmRailoutVltController($scope, apiService, helperService, appConfig, myTaskActivityConfig, APP_CONSTANT, authService, errorWarningService) {
        ...
        function GetEntityObj() {
            if (ImportSeaConsolConfirmRailoutVltCtrl.ePage.Masters.TaskObj.EntityRefKey) {
                apiService.get("eAxisAPI", appConfig.Entities.ConsolList.API.GetByID.Url + ImportSeaConsolConfirmRailoutVltCtrl.ePage.Masters.TaskObj.EntityRefKey).then(function (response) {
                    if (response.data.Response) {
                        ImportSeaConsolConfirmRailoutVltCtrl.ePage.Masters.EntityObj = response.data.Response;
                        console.log(ImportSeaConsolConfirmRailoutVltCtrl.ePage.Masters.EntityObj)
                    }
                });
            }
        }
