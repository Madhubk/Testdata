(function () {
    ...
    angular
        .module("Application")
        .factory('three_TrackcontainerConfig', three_TrackcontainerConfig);

    three_TrackcontainerConfig.$inject = ["$rootScope", "$location", "$q", "apiService", "authService", "helperService", "toastr", "appConfig", "$timeout", "freightApiConfig"];

    function three_TrackcontainerConfig($rootScope, $location, $q, apiService, authService, helperService, toastr, appConfig, $timeout, freightApiConfig) {
        var exports = {
            "Entities": {
                "Header": {
                    "Data": {},
