(function () {
    ...
    angular
        .module("Application")
        .controller("BuyerActivityFormTemplate1Controller", BuyerActivityFormTemplate1Controller);

    BuyerActivityFormTemplate1Controller.$inject = ["$scope", "apiService", "helperService", "appConfig", "myTaskActivityConfig"];

    function BuyerActivityFormTemplate1Controller($scope, apiService, helperService, appConfig, myTaskActivityConfig) {
