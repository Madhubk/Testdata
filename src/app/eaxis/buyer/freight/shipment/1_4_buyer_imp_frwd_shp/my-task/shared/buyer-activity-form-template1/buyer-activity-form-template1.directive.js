(function () {
    ...
    angular
        .module("Application")
        .directive("buyerActivityFormTemplate1", BuyerActivityFormTemplate1Directive)
        .directive("buyerTaskActivityDynamicDirective", TaskActivityDynamicDirective);

    function BuyerActivityFormTemplate1Directive() {
        var exports = {
            restrict: "EA",
            templateUrl: "app/eaxis/buyer/freight/shipment/1_4_buyer_imp_frwd_shp/my-task/shared/buyer-activity-form-template1/buyer-activity-form-template1.html",
            link: Link,
            controller: "BuyerActivityFormTemplate1Controller",
