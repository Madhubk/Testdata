(function () {
    ...
    angular
        .module("Application")
        .factory('one_three_BookingConfig', one_three_BookingConfig);

    one_three_BookingConfig.$inject = ["$rootScope", "$location", "$q", "apiService", "helperService", "toastr", "errorWarningService"];

    function one_three_BookingConfig($rootScope, $location, $q, apiService, helperService, toastr, errorWarningService) {
        var exports = {
            "Entities": {
                "Header": {
                    "Data": {},
