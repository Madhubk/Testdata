(function () {
    ...
    ConfirmCarrierController.$inject = ["$window", "helperService", "apiService", "appConfig", "myTaskActivityConfig"];

    function ConfirmCarrierController($window, helperService, apiService, appConfig, myTaskActivityConfig) {
        ...
        function getRoutingProperties() {
            ConfirmCarrierCtrl.ePage.Masters.RoutingHeader = {
