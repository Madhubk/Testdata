(function () {
    ...
    function ConvertBookingSupplierEditDirectiveController($scope, $uibModal, $window, $q, $injector, helperService, apiService, authService, appConfig, APP_CONSTANT, toastr, errorWarningService, confirmation) {
        ...
        function SFUMailInit() {
            ...
            console.log(ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.TaskObj);
            FollowUpOrderGrid();
        }

        function FollowUpOrderGrid() {
            apiService.get("eAxisAPI", appConfig.Entities.ShipmentPreAdvice.API.GetOrdersByGroupPK.Url + ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.TaskObj.EntityRefKey).then(function (response) {
        ...
        function ConvertBooking(data) {
            if (ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.SelectedOrder.length > 0) {
                ...
                // ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.addContainer = AddContainer;
                // ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.deleteContainer = DeleteContainer;
                // //Packlines
                // ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.PackObj = {};
                // ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.PackObj.JobLocation = [];
                // ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.PackObj.PkgCntMapping = [];
                // ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.PackObj.JobDangerousGoods = [];
                // ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.packageAdd = PackageAdd;
                // ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.deletePackage = DeletePackage;
        ...
        function initBooking() {
            apiService.get("eAxisAPI", appConfig.Entities.ShipmentList.API.GetById.Url + "null").then(function (response) {
                if (response.data.Response) {
                    ...
                    console.log(ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.TabObj)
                }
            });
        }
        ...
        function OrderGetById() {
            ...
            apiService.get("eAxisAPI", appConfig.Entities.OrderList.API.GetById.Url + ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.SelectedOrder[0].POH_FK).then(function (response) {
                if (response.data.Response) {
                    ...
                    var obj = _.filter(ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.cfxTypeList.CntType, {
                        'Key': ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.defaultOrder.UIPorOrderHeader.ContainerMode
                    })[0];
                    ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.selectedMode = obj
                    ConvertBookingSupplierEditDirectiveCtrl.ePage.Entities.Header.Data.UIShipmentHeader.TransportMode = ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.defaultOrder.UIPorOrderHeader.TransportMode;
                    ConvertBookingSupplierEditDirectiveCtrl.ePage.Entities.Header.Data.UIShipmentHeader.PackingMode = ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.defaultOrder.UIPorOrderHeader.ContainerMode;
                    ConvertBookingSupplierEditDirectiveCtrl.ePage.Entities.Header.Data.UIShipmentHeader.IncoTerm = ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.defaultOrder.UIPorOrderHeader.IncoTerm;
                    ConvertBookingSupplierEditDirectiveCtrl.ePage.Entities.Header.Data.UIShipmentHeader.CargoReadyDate = ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.defaultOrder.UIPorOrderHeader.CargoReadyDate;
                    ConvertBookingSupplierEditDirectiveCtrl.ePage.Entities.Header.Data.UIShipmentHeader.Origin = ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.defaultOrder.UIPorOrderHeader.GoodsAvailableAt;
                    ConvertBookingSupplierEditDirectiveCtrl.ePage.Entities.Header.Data.UIShipmentHeader.Destination = ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.defaultOrder.UIPorOrderHeader.GoodsDeliveredTo;
                    ConvertBookingSupplierEditDirectiveCtrl.ePage.Entities.Header.Data.UIShipmentHeader.PortOfLoading = ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.defaultOrder.UIPorOrderHeader.PortOfLoading;
                    ConvertBookingSupplierEditDirectiveCtrl.ePage.Entities.Header.Data.UIShipmentHeader.PortOfDischarge = ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.defaultOrder.UIPorOrderHeader.PortOfDischarge;
            ...
            apiService.post("eAxisAPI", appConfig.Entities.OrgBuyerSupplierMapping.API.FindAll.Url, _input).then(function (response) {
                if (response.data.Response) {
                    ...
                    var tempBuyObj = _.filter(ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.OrgBuyerDetails, {
                        'ORG_Buyer': ConvertBookingSupplierEditDirectiveCtrl.ePage.Masters.defaultOrder.UIPorOrderHeader.ORG_Buyer_FK
                    })[0];
