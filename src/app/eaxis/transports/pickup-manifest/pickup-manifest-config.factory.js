(function () {
    ...
    angular
        .module("Application")
        .factory('pickupManifestConfig', PickupManifestConfig);

    PickupManifestConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function PickupManifestConfig($location, $q, helperService, apiService, toastr) {
