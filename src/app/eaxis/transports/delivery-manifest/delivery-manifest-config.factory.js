(function () {
    ...
    angular
        .module("Application")
        .factory('deliveryManifestConfig', DeliveryManifestConfig);

    DeliveryManifestConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function DeliveryManifestConfig($location, $q, helperService, apiService, toastr) {
