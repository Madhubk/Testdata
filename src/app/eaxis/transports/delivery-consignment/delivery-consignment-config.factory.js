(function () {
    ...
    angular
        .module("Application")
        .factory('deliveryConsignmentConfig', DeliveryConsignmentConfig);

    DeliveryConsignmentConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function DeliveryConsignmentConfig($location, $q, helperService, apiService, toastr) {
