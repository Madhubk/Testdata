(function () {
    ...
    angular
        .module("Application")
        .factory('consignmentConfig', ConsignmentConfig);

    ConsignmentConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function ConsignmentConfig($location, $q, helperService, apiService, toastr) {
