(function () {
    ...
    angular
        .module("Application")
        .factory('adminConsignmentConfig', AdminConsignmentConfig);

    AdminConsignmentConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function AdminConsignmentConfig($location, $q, helperService, apiService, toastr) {
                    ...
                    "Header": {
                        ...
                        "Meta": {
                            "MenuList": [{
                                ...
                                "Value": "General",
                                "Icon": "fa-plane",
                                "GParentRef": "consignmentgeneral"
                            }, {
                                "DisplayName": "Consignment Item",
                                "Value": "Consignment Item",
                                "Icon": "fa-plane",
                                "GParentRef": "consignmentitem"
                            }, {
