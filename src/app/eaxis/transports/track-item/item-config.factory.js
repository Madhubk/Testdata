(function () {
    ...
    angular
        .module("Application")
        .factory('itemConfig', ItemConfig);

    ItemConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function ItemConfig($location, $q, helperService, apiService, toastr) {
