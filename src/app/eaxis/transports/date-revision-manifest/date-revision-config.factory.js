(function () {
    ...
    angular
        .module("Application")
        .factory('dateRevisionConfig', DateRevisionConfig);

        DateRevisionConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function DateRevisionConfig($location, $q, helperService, apiService, toastr) {
