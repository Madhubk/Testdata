(function () {
    ...
    angular
        .module("Application")
        .factory('dateRevisionConsignmentConfig', DateRevisionConsignmentConfig);

    DateRevisionConsignmentConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function DateRevisionConsignmentConfig($location, $q, helperService, apiService, toastr) {
