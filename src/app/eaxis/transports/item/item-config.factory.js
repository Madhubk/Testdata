(function () {
    ...
    angular
        .module("Application")
        .factory('adminItemConfig', AdminItemConfig);

    AdminItemConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function AdminItemConfig($location, $q, helperService, apiService, toastr) {
                ...
                "Header": {
                    ...
                    "API": {
                        ...
                        "SessionClose": {
                            "IsAPI": "true",
                            "HttpType": "GET",
                            "Url": "TmsItemList/ItemHeaderActivityClose/",
                        },
                    },
                    "Meta": {
        ...
        function GetTabDetails(currentItem, isNew) {
                    ...
                    "Header": {
                        ...
                        "API": {
                            "InsertItem": {
                                "IsAPI": "true",
                                "HttpType": "POST",
                                "Url": "TmsItemList/Insert"
                            },
                            "UpdateItem": {
                                "IsAPI": "true",
                                "HttpType": "POST",
                                "Url": "TmsItemList/Update"
                            },
                            "CfxTypes": {
                                "IsAPI": "true",
                                "HttpType": "POST",
                        ...
                        "Meta": {
                            "MenuList": [{
                                ...
                                "Value": "General",
                                "Icon": "fa-cubes",
                                "GParentRef": "itemgeneral"
                            }, {
                                "DisplayName": "Consignment",
                                "Value": "Consignment",
                                "Icon": "fa-cubes",
                                "GParentRef": "consignment"
                            }, {
                            ...
                            "ErrorWarning": {
                                ...
                                // "ItemCode": helperService.metaBase(),
                            },
                        },
                        "CheckPoints": {
                            "DisableSave": false,
            ...
            if (isNew) {
                _exports.Entities.Header.Data = currentItem.data;
                _exports.Entities.Header.GetById = currentItem.data;
                _exports.Entities.Header.Validations = currentItem.Validations;
                var obj = {
                    New: {
                        ePage: _exports
                    },
                    label: 'New',
                    code: currentItem.entity.ItemCode,
                    isNew: isNew
                };
                ...
                apiService.get("eAxisAPI", exports.Entities.Header.API.GetByID.Url + currentItem.PK).then(function (response) {
