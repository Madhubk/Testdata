(function () {
    ...
    EAxisDashboardController.$inject = ["$window", "authService", "apiService", "helperService", "appConfig", "$location"];

    function EAxisDashboardController($window, authService, apiService, helperService, appConfig, $location) {
        ...
        function Init() {
            ...
            EAxisDashboardCtrl.ePage.Masters.ChangeTenant = ChangeTenant;
            EAxisDashboardCtrl.ePage.Masters.ChangeParty = ChangeParty;
            EAxisDashboardCtrl.ePage.Masters.ChangeRole = ChangeRole;
