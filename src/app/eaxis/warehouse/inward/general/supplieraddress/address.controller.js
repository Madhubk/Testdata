(function () {
    ...
    SupplierAddressController.$inject = ["$rootScope", "$uibModalInstance","$scope", "$state", "$q", "$location", "$timeout", "APP_CONSTANT", "authService", "apiService", "appConfig", "inwardConfig", "helperService", "toastr", "$filter","$injector","myData"];
    
    function SupplierAddressController($rootScope, $uibModalInstance,$scope, $state, $q, $location, $timeout, APP_CONSTANT, authService, apiService, appConfig, inwardConfig, helperService, toastr, $filter,$injector,myData) {
