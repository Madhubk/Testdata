    ...
    function InventoryConfig($location, $q, helperService, apiService) {
        ...
        function GetTabDetails(currentInventory, isNew, DataEntryName) {
            ...
            if (isNew) {
                ...
                if(DataEntryName == "CustomerInventoryByProduct"){
                    var _filter = {
                        "WAR_FK": currentInventory.WAR_FK,
                        "ORG_FK": currentInventory.ORG_FK,
                        "PRO_FK": currentInventory.PRO_FK
                    };
                }else if(DataEntryName == "CustomerInventoryByAttribute"){
                    var _filter = {
                        "WAR_FK": currentInventory.WAR_FK,
                        "ORG_FK": currentInventory.ORG_FK,
                        "PRO_FK": currentInventory.PRO_FK,
                ...
                }else if(DataEntryName == "CustomerInventoryByLocation"){
                    var _filter = {
                        "WAR_FK": currentInventory.WAR_FK,
                        "ORG_FK": currentInventory.ORG_FK,
                        "PRO_FK": currentInventory.PRO_FK,
                ...
                }else if(DataEntryName == "CustomerWarehouseInventory"){
                    var _filter = {
