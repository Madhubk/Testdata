(function () {
    ...
    OutwardMyTaskController.$inject = ["helperService", "appConfig", "apiService", "authService", "$ocLazyLoad"];

    function OutwardMyTaskController(helperService, appConfig, apiService, authService, $ocLazyLoad) {
        ...
        function Init() {
            ...
            if (OutwardMyTaskCtrl.listSource) {
                OutwardMyTaskCtrl.ePage.Masters.MyTask.ListSource = angular.copy(OutwardMyTaskCtrl.listSource);
            } else {
                OutwardMyTaskCtrl.ePage.Masters.MyTask.ListSource = [];
            }
            (OutwardMyTaskCtrl.obj) ? GetMyTaskList() : false;
        }
