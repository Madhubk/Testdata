(function () {
    ...
    angular
        .module("Application")
        .factory('ownershipTransferConfig', OwnerTransferConfig);

    OwnerTransferConfig.$inject = ["$location", "$q", "helperService", "apiService", "appConfig"];

    function OwnerTransferConfig($location, $q, helperService, apiService, appConfig) {
        var exports = {
            "Entities": {
                "Header": {
                    "RowIndex": -1,
        ...
        function GetTabDetails(currentOwnerTransfer, isNew) {            
            ...
            if (isNew) {
                _exports.Entities.Header.Data = currentOwnerTransfer.data;
                var _obj = {
                    New: {
                        ePage: _exports
                    },
                    label: 'New',
                    code: currentOwnerTransfer.entity.WorkOrderID,
                    isNew: isNew
                };
                ...
                apiService.get("eAxisAPI", exports.Entities.Header.API.GetByID.Url + currentOwnerTransfer.PK).then(function (response) {

                    _exports.Entities.Header.Data = response.data.Response;

                    var obj = {
                        [currentOwnerTransfer.WorkOrderID]: {
                            ePage: _exports
                        },
                        label: currentOwnerTransfer.WorkOrderID,
                        code: currentOwnerTransfer.WorkOrderID,
                        isNew: isNew
                    };
