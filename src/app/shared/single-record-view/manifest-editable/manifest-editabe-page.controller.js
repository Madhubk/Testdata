(function () {
    ...
    function SRVManifestEditableController($rootScope, $scope, $location, $timeout, $injector, APP_CONSTANT, authService, apiService, helperService, toastr, appConfig) {
        ...
        function Init() {
            ...
            console.log(SRVManifestEditableCtrl.ePage.Masters);
        ...
        function GetDynamicLookupConfig() {
            ...
            apiService.post("eAxisAPI", "DataEntryMaster/FindAll", _input).then(function (response) {
                ...
                res.map(function (value, key) {
                    SRVManifestEditableCtrl.ePage.Masters.dynamicLookupConfig[value.DataEntryName] = value;
                });
            });
        }
        ...
        function GetTabDetails(curRecord) {
            ...
            Config.GetTabDetails(curRecord, false).then(function (response) {
                ...
                console.log(SRVManifestEditableCtrl.ePage.Masters.CurrentObj);
            });
        }
