(function () {
    ...
    AppController.$inject = ['$rootScope', '$scope', '$localStorage', '$state', '$timeout', '$location', 'authService', 'apiService', 'toastr'];

    function AppController($rootScope, $scope, $localStorage, $state, $timeout, $location, authService, apiService, toastr) {
        var AppCtrl = this;
        AppCtrl.IsShowLoginPopup = false;
