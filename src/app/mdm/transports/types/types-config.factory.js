(function () {
    ...
    angular
        .module("Application")
        .factory('typeConfig', TypeConfig);

    TypeConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function TypeConfig($location, $q, helperService, apiService, toastr) {
                ...
                "Header": {
                    ...
                    "API": {
                        ...
                        "InsertCfxTypes": {
                            "IsAPI": "true",
                            "HttpType": "POST",
                            "Url": "CfxTypes/Insert/null"
                        },
                        "UpdateCfxTypes": {
                            "IsAPI": "true",
                            "HttpType": "POST",
                            "Url": "CfxTypes/Update/null"
                        },
                        "CfxTypesFindall": {
                            "IsAPI": "true",
                            "HttpType": "POST",
                        ...
                        "UpdateMstContainer": {
                            "IsAPI": "true",
                            "HttpType": "POST",
                            "Url": "MstContainer/Update"
                        },
                        "InsertMstContainer": {
                            "IsAPI": "true",
                            "HttpType": "POST",
                            "Url": "MstContainer/Insert"
                        },
                        "InsertOrgRefDate": {
                            "IsAPI": "true",
                            "HttpType": "POST",
                            "Url": "OrgRefDate/Insert"
                        },
                        "UpdateOrgRefDate": {
                            "IsAPI": "true",
                            "HttpType": "POST",
                            "Url": "OrgRefDate/Update"
                        },
        ...
        function GetTabDetails(currentType, isNew) {
            ...
            if (isNew) {
                _exports.Entities.Header.Data = currentType.data;
                _exports.Entities.Header.GetById = currentType.data;
                _exports.Entities.Header.Validations = currentType.Validations;
                var obj = {
                    [currentType.entity.MappingCode]: {
                        ePage: _exports
                    },
                    label: currentType.entity.MappingCode,
                    isNew: isNew
                };
                ...
                apiService.get("eAxisAPI", exports.Entities.Header.API.GetByID.Url + currentType.PK).then(function (response) {

                    _exports.Entities.Header.Data = response.data.Response;
                    _exports.Entities.Header.Validations = response.data.Validations;

                    var obj = {
                        [currentType.MappingCode]: {
                            ePage: _exports
                        },
                        label: currentType.MappingCode,
                        isNew: isNew
                    };
                    exports.TabList.push(obj);
                    deferred.resolve(exports.TabList);
        ...
        function GeneralValidation($item) {
            ...
            // if (!_input.TmsCfxTypesHeader.SenderCode || _input.TmsCfxTypesHeader.SenderCode) {
            //     OnChangeValues(_input.TmsCfxTypesHeader.SenderCode, 'E5501', false, undefined, $item.label);
            // }
        }
