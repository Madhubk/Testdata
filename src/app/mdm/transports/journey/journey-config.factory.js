(function () {
    ...
    angular
        .module("Application")
        .factory('journeyConfig', JourneyConfig);

    JourneyConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function JourneyConfig($location, $q, helperService, apiService, toastr) {
        ...
        function GetTabDetails(currentJourney, isNew) {
            ...
            if (isNew) {
                ...
                apiService.get("eAxisAPI", exports.Entities.Header.API.GetByID.Url + currentJourney.PK).then(function (response) {
