(function () {
    ...
    angular
        .module("Application")
        .factory('regionConfig', RegionConfig);

    RegionConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function RegionConfig($location, $q, helperService, apiService, toastr) {
        ...
        function GetTabDetails(currentRegion, isNew) {
                    ...
                    "Header": {
                        ...
                        "API": {
                            "InsertRegion": {
                                "IsAPI": "true",
                                "HttpType": "POST",
                                "Url": "MstRegion/Insert"
                            },
                            "UpdateRegion": {
                                "IsAPI": "true",
                                "HttpType": "POST",
                                "Url": "MstRegion/Update"
                            },
                            "CfxTypes": {
                                "IsAPI": "true",
                                "HttpType": "POST",
            ...
            if (isNew) {
                _exports.Entities.Header.Data = currentRegion.data.Response;
                _exports.Entities.Header.GetById = currentRegion.data.Response;
                _exports.Entities.Header.Validations = currentRegion.Validations;
                var obj = {
                    New: {
                        ePage: _exports
                    },
                    label: 'New',
                    Code: currentRegion.entity.Code,
                    isNew: isNew
                };
                ...
                apiService.get("eAxisAPI", exports.Entities.Header.API.GetByID.Url + currentRegion.PK).then(function (response) {
        ...
        function GeneralValidation($item) {
            ...
            if (!_input.Code || _input.Code) {
                OnChangeValues(_input.Code, 'E5543', false, undefined, $item.label);
            }
            if (!_input.Name || _input.Name) {
                OnChangeValues(_input.Name, 'E5544', false, undefined, $item.label);
            }
        }
