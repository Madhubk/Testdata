(function () {
    ...
    angular
        .module("Application")
        .factory('legConfig', LegConfig);

    LegConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function LegConfig($location, $q, helperService, apiService, toastr) {
        ...
        function GetTabDetails(currentLeg, isNew) {
                    ...
                    "Header": {
                        ...
                        "API": {
                            "InsertLeg": {
                                "IsAPI": "true",
                                "HttpType": "POST",
                                "Url": "TmsLegTemplate/Insert"
                            },
                            "UpdateLeg": {
                                "IsAPI": "true",
                                "HttpType": "POST",
                                "Url": "TmsLegTemplate/Update"
                            },
                            "CfxTypes": {
                                "IsAPI": "true",
                                "HttpType": "POST",
            ...
            if (isNew) {
                ...
                apiService.get("eAxisAPI", exports.Entities.Header.API.GetByID.Url + currentLeg.PK).then(function (response) {
