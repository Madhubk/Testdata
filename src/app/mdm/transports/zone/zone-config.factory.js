(function () {
    ...
    angular
        .module("Application")
        .factory('zoneConfig', ZoneConfig);

    ZoneConfig.$inject = ["$location", "$q", "helperService", "apiService", "toastr"];

    function ZoneConfig($location, $q, helperService, apiService, toastr) {
        ...
        function GetTabDetails(currentZone, isNew) {
            ...
            if (isNew) {
                ...
                apiService.get("eAxisAPI", exports.Entities.Header.API.GetByID.Url + currentZone.PK).then(function (response) {
