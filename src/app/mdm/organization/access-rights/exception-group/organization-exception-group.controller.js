(function () {
    ...
    OrganizationExceptionGroupController.$inject = ["helperService", "appConfig", "apiService", "authService"];

    function OrganizationExceptionGroupController(helperService, appConfig, apiService, authService) {
        ...
        function GetExceptionGroupList() {
            ...
            apiService.post("eAxisAPI", appConfig.Entities.MstExceptionType.API.FindAll.Url, _input).then(function (response) {
        ...
        function DeleteExceptionGroup($item) {
            if ($item.OrgExceptionGroup) {
                var _input = $item.OrgExceptionGroup;
