(function () {
    ...
    OrganizationConsigneeController.$inject = ["$scope", "APP_CONSTANT", "authService", "$uibModal", "apiService", "appConfig", "organizationConfig", "helperService", "toastr"];

    function OrganizationConsigneeController($scope, APP_CONSTANT, authService, $uibModal, apiService, appConfig, organizationConfig, helperService, toastr) {
        ...
        function Init() {
            ...
            OrganizationConsigneeCtrl.ePage.Masters.OrgContact = {};
            OrganizationConsigneeCtrl.ePage.Masters.DropDownMasterList = organizationConfig.Entities.Header.Meta;
            ...
            // Consignee function
            OrganizationConsigneeCtrl.ePage.Masters.Consignee = {};
            OrganizationConsigneeCtrl.ePage.Masters.Consignee.ConsigneeGridCall = ConsigneeGridCall;            
        ...
        function ConsigneeGridCall() {
            ...
            OrganizationConsigneeCtrl.ePage.Masters.SupplierGridDetails.gridConfig = OrganizationConsigneeCtrl.ePage.Entities.Header.OrgBuyerSupplierMappingDeatils.gridConfig;
            OrganizationConsigneeCtrl.ePage.Masters.SupplierGridDetails.gridConfig.columnDef = OrganizationConsigneeCtrl.ePage.Entities.Header.OrgBuyerSupplierMappingDeatils.gridConfig.columnDef;
            console.log(OrganizationConsigneeCtrl.ePage.Entities.Header.Data)
            var _filter = {
        ...
        function SelectedConsignorRow(item) {
            ...
            OrganizationConsigneeCtrl.ePage.Masters.Supplier.IsFormView = true;
            // get details call
            apiService.get('eAxisAPI', OrganizationConsigneeCtrl.ePage.Entities.Header.OrgBuyerSupplierMappingDeatils.API.GetByID.Url + item.data.PK).then(function (response) {
                if (response.data.Response) {             
                    if(response.data.Response.length > 0){
        ...
        function GetFollowUpSourceDetails() {
            ...
            var _filter = {
                "ModuleCode" : "ConsignorFollowUp",
                "EntitySource" : "Config",
                "SourceEntityRefKey" : "ORG "
            }
            var _input = {
                "searchInput" : helperService.createToArrayOfObject(_filter),
                "FilterID" : "APPSETT"
